...
sys.path.insert(0, os.path.abspath(os.path.join('..','pypower')))
...
autodoc_mock_imports = ['mpi4py', 'pmesh']
...
git_repo = 'https://github.com/cosmodesi/pypower.git'
git_root = 'https://github.com/cosmodesi/pypower/blob/main/'
